namespace Test.Common
{
    ...
    {
        public static string ConnectionString_Write_MySql = "server=127.0.0.1;Port=3306;database=SevenTinyTest;uid=sa;pwd=123456;Allow User Variables=true;SslMode=none;";
